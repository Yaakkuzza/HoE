...
NCountry = {
	...
	POWER_MAX = 1200,								-- how much power can be stored at maximum.
	...
	DEBT_LIMIT_ADM = -1200,							-- This is how far you can go into debt on ADM for actions that allow spending power you don't have.
	DEBT_LIMIT_DIP = -1200,							-- This is how far you can go into debt on DIP for actions that allow spending power you don't have.
	DEBT_LIMIT_MIL = -1200,							-- This is how far you can go into debt on MIL for actions that allow spending power you don't have.
	MAX_FERVOR = 100.0,
...
NAI = {
	...
	UNCONDITIONAL_SURRENDER_HOPELESS_STRENGTH_COMPARISON = 10, -- if they have 20 times the army strength you do, wave the white flag
